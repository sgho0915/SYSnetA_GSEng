		...
		IPointerEnterHandler, IPointerExitHandler, ILateUpdatable
	{
		...
		protected struct Target
		{
			...
			public Target(RectTransform rectTransform)
			{
				...
				SplitterMaxSize = RectTransform.GetComponent<SplitterMaxSize>();
			...
			public void ChangeWidth(float delta, Target sibling, bool integerSize, bool updateRectTransform, bool updateLayoutElement)
			{
			...
			/// <param name="updateRectTransform">Update RectTransform height.</param>
			/// <param name="updateLayoutElement">Update LayoutElement height.</param>
			public void ChangeHeight(float delta, Target sibling, bool integerSize, bool updateRectTransform, bool updateLayoutElement)
			{
