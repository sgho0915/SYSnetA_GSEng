...
#pragma warning restore 0618
		...
		public virtual void SetCellsSize<TList>(TList sizes, bool withListView = true)
			where TList : IList<float>
		{
...
#region IDropSupport<TableHeaderCell>
		...
		protected virtual void RecalculateSizes(TableHeaderCellInfo enabledCell)
		{
			...
			var min_flexible = enabledCell.Rect.parent.GetComponent<EasyLayoutNS.EasyLayout>() != null ? 0f : 1f;
