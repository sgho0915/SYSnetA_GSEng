namespace UIWidgets
{
		...
		where TItemView : ListViewItem
	{
		...
		/// <inheritdoc/>
		public override bool LoopedListAvailable => LoopedList && Virtualization && ListRenderer.IsVirtualizationSupported() && ListRenderer.AllowLoopedList;
...
#pragma warning restore 0618
		...
		/// <inheritdoc/>
		public override void SetTableSizes<TList>(TList sizes, bool withHeader = true)
		{
